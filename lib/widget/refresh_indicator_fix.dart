...
class RefreshIndicatorFix extends StatefulWidget {
  ...
  @override
  RefreshIndicatorFixState createState() => RefreshIndicatorFixState();
}

/// Contains the state for a [RefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class RefreshIndicatorFixState extends State<RefreshIndicatorFix>
    with TickerProviderStateMixin<RefreshIndicatorFix> {
